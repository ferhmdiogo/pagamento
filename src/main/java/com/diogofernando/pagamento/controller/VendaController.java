package com.diogofernando.pagamento.controller;
...
import com.diogofernando.services.VendaService;
...
public class VendaController {
	...
	public ResponseEntity<?> findAll(@RequestParam(value = "page", defaultValue = "12") int page,
			@RequestParam(value = "limikt", defaultValue = "12") int limit,
